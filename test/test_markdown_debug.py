"""
Debug script to test markdown formatting with Korean text
"""
import sys
...
# Test with the actual text from the issue
...
print("Testing markdown formatting with Korean legal text...")
print("=" * 80)

formatted = format_response_with_markdown(test_text)

print("\nOriginal text length:", len(test_text))
print("Formatted text length:", len(formatted))
print("\nFirst 500 characters of formatted text:")
print(formatted[:500])
print("\nLast 500 characters of formatted text:")
print(formatted[-500:])

# Check for markdown syntax
print("\n" + "=" * 80)
print("Markdown syntax analysis:")
print("Has bold (**):", "**" in formatted)
print("Has italic (*):", "*" in formatted)
print("Has code (`):", "`" in formatted)
print("Has headers (#):", "#" in formatted)
print("Has lists (-):", "-" in formatted)

# Check for escaped characters
print("\n" + "=" * 80)
print("Escaped characters analysis:")
print("Has escaped *: ", "\\*" in formatted)
print("Has escaped _: ", "\\_" in formatted)
print("Has escaped `: ", "\\`" in formatted)
print("Has escaped #: ", "\\#" in formatted)
print("Has escaped -: ", "\\-" in formatted)

print("\n" + "=" * 80)
print("Sample of formatted text (first 1000 chars):")
